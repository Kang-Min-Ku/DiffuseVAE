# CIFAR-10 (Form-1)
python main/train_joint.py +dataset=cifar10/train \
                     dataset.ddpm.data.root=\'/data2/ssongzoe/unifiedDiffuseVAE/datasets/cifar10/\' \
                     ...
                     dataset.ddpm.training.results_dir=\'/data2/ssongzoe/unifiedDiffuseVAE/results/jointdiffusevae_cifar10_rework_form2_28thJuly_sota_nheads=8_dropout=0.3/\' \
                     dataset.ddpm.training.workers=5 \
                     dataset.ddpm.training.chkpt_prefix=\'cifar10_rework_form1_28thJuly_sota_nheads=8_dropout=0.3\' \
                     dataset.vae.training.alpha=1.0 \
                     dataset.vae.training.results_dir=\'/data2/ssongzoe/unifiedDiffuseVAE/checkpoints/cifar10/\' \
