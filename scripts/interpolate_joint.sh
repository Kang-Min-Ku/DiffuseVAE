python main/eval/ddpm/interpolate_vae_joint.py +dataset=cifar10/test \
                            ...
                            dataset.ddpm.evaluation.seed=2024 \
                            dataset.ddpm.evaluation.chkpt_path=\'/data2/ssongzoe/unifiedDiffuseVAE/results/jointdiffusevae_cifar10_form2_uniform/checkpoints/ddpmv2-cifar10_rework_form1_28thJuly_sota_nheads=8_dropout=0.3-epoch=499-loss=14.1352.ckpt\' \
                            ...
                            dataset.ddpm.evaluation.save_path=\'/data2/ssongzoe/unifiedDiffuseVAE/interpolation/jointVAE\' \
                            ...
                            dataset.vae.evaluation.chkpt_path=\'\' \
