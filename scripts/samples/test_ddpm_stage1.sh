...
python main/eval/ddpm/sample_cond.py +dataset=cifar10/test \
                        ...
                        dataset.ddpm.evaluation.device=\'gpu:0\' \
                        dataset.ddpm.evaluation.save_mode='image' \
                        dataset.ddpm.evaluation.chkpt_path=\'/home/dj/course-diffusevae-20241212/checkpoints/ddpm-cifar10-stage1-form1/checkpoints/ddpmv2-cifar10_nheads=8_dropout=0.3-epoch=499-loss=0.0209.ckpt\' \
                        ...
                        dataset.ddpm.evaluation.sample_from='target' \
                        dataset.ddpm.evaluation.temp=1.0 \
                        dataset.ddpm.evaluation.batch_size=512 \
                        dataset.ddpm.evaluation.save_path=\'/home/dj/course-diffusevae-20241212/samples/ddpm-cifar10-cond-stage1-form1-50000/\' \
                        dataset.ddpm.evaluation.z_cond=False \
                        dataset.ddpm.evaluation.n_samples=50000 \
                        dataset.ddpm.evaluation.n_steps=1000 \
                        dataset.ddpm.evaluation.save_vae=True \
                        dataset.ddpm.evaluation.workers=2 \
                        dataset.vae.evaluation.chkpt_path=\'/home/dj/course-diffusevae-20241212/checkpoints/vae-cifar10-stage1/checkpoints/vae-vae-cifar10-epoch=499-train_loss=0.0000.ckpt\' \
                        dataset.vae.evaluation.expde_model_path=\'/home/dj/course-diffusevae-20241212/gmms/gmm_50.joblib\'
