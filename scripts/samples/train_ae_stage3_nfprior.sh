python main/train_ae.py +dataset=cifar10/train \
                     dataset.vae.data.root='/home/dj/course-diffusevae-20241218-stage3-nfprior/datasets/cifar10' \
                     ...
                     dataset.vae.training.results_dir=\'/home/dj/course-diffusevae-20241218-stage3-nfprior/checkpoints/vae-cifar10-phase3-nfprior/\' \
                     dataset.vae.training.workers=2 \
                     dataset.vae.training.chkpt_prefix=\'vae-cifar10\' \
                     dataset.vae.training.alpha=0.025
