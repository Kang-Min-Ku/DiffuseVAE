...
#                         dataset.ddpm.evaluation.device=\'gpu:0\' \
#                         dataset.ddpm.evaluation.save_mode='image' \
#                         dataset.ddpm.evaluation.chkpt_path=\'\' \
#                         dataset.ddpm.evaluation.type='uncond' \
...
#                         dataset.ddpm.evaluation.save_path=\'/data2/ssongzoe/unifiedDiffuseVAE/samples\' \
#                         dataset.ddpm.evaluation.n_samples=2500 \
#                         dataset.ddpm.evaluation.n_steps=100 \
#                         dataset.ddpm.evaluation.workers=1 \


python main/eval/ddpm/sample_cond_joint.py +dataset=cifar10/test \
                        dataset.ddpm.data.norm=True \
                        ...
                        dataset.ddpm.evaluation.save_mode='image' \
                        dataset.ddpm.evaluation.chkpt_path=\'/data2/ssongzoe/unifiedDiffuseVAE/results/jointdiffusevae_cifar10_rework_form2_28thJuly_sota_nheads=8_dropout=0.3/checkpoints/ddpmv2-cifar10_rework_form1_28thJuly_sota_nheads=8_dropout=0.3-epoch=499-loss=14.1611.ckpt\' \
                        dataset.ddpm.evaluation.type='form2' \
                        ...
                        dataset.ddpm.evaluation.temp=1.0 \
                        dataset.ddpm.evaluation.batch_size=64 \
                        dataset.ddpm.evaluation.save_path=\'/data2/ssongzoe/unifiedDiffuseVAE/samples/jointVAE/20000\' \
                        dataset.ddpm.evaluation.z_cond=False \
                        dataset.ddpm.evaluation.n_samples=20000 \
                        dataset.ddpm.evaluation.n_steps=1000 \
                        dataset.ddpm.evaluation.save_vae=True \
                        dataset.ddpm.evaluation.workers=5 \
                        dataset.vae.evaluation.chkpt_path=\'/data2/ssongzoe/unifiedDiffuseVAE/checkpoints/cifar10/checkpoints/vae-vae-cifar10-epoch=500-train_loss=0.00-epoch=499-train_loss=0.0000.ckpt\' \
                        dataset.vae.evaluation.expde_model_path=\'/data2/ssongzoe/unifiedDiffuseVAE/latents/gmm_50.joblib\'
