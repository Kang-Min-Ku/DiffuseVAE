...
from models.diffusion import DDPM, DDPMv2, DDPMWrapper, SuperResModel, JointWrapper
...
def sample_cond(config):
    os.makedirs(config.dataset.ddpm.evaluation.save_path, exist_ok=True)
    ...
    ddpm_wrapper = JointWrapper.load_from_checkpoint(
